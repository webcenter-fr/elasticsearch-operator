...
type serviceAccountReconciler struct {
	multiphase.MultiPhaseStepReconcilerAction[*kibanacrd.Kibana, *corev1.ServiceAccount]
	isOpenshift bool
}

func newServiceAccountReconciler(client client.Client, recorder record.EventRecorder, isOpenshift bool) (multiPhaseStepReconcilerAction multiphase.MultiPhaseStepReconcilerAction[*kibanacrd.Kibana, *corev1.ServiceAccount]) {
	return &serviceAccountReconciler{
		MultiPhaseStepReconcilerAction: multiphase.NewMultiPhaseStepReconcilerAction[*kibanacrd.Kibana, *corev1.ServiceAccount](
			client,
			ServiceAccountPhase,
...
func (r *serviceAccountReconciler) Read(ctx context.Context, o *kibanacrd.Kibana, data map[string]any, logger *logrus.Entry) (read multiphase.MultiPhaseRead[*corev1.ServiceAccount], res reconcile.Result, err error) {
