...
type roleBindingReconciler struct {
	multiphase.MultiPhaseStepReconcilerAction[*elasticsearchcrd.Elasticsearch, *rbacv1.RoleBinding]
	isOpenshift bool
}

func newRoleBindingReconciler(client client.Client, recorder record.EventRecorder, isOpenshift bool) (multiPhaseStepReconcilerAction multiphase.MultiPhaseStepReconcilerAction[*elasticsearchcrd.Elasticsearch, *rbacv1.RoleBinding]) {
	return &roleBindingReconciler{
		MultiPhaseStepReconcilerAction: multiphase.NewMultiPhaseStepReconcilerAction[*elasticsearchcrd.Elasticsearch, *rbacv1.RoleBinding](
			client,
			RoleBindingPhase,
...
func (r *roleBindingReconciler) Read(ctx context.Context, o *elasticsearchcrd.Elasticsearch, data map[string]any, logger *logrus.Entry) (read multiphase.MultiPhaseRead[*rbacv1.RoleBinding], res reconcile.Result, err error) {
...
func (r *roleBindingReconciler) Update(ctx context.Context, o *elasticsearchcrd.Elasticsearch, data map[string]any, objects []*rbacv1.RoleBinding, logger *logrus.Entry) (res reconcile.Result, err error) {
