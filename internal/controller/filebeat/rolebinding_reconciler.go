...
type roleBindingReconciler struct {
	multiphase.MultiPhaseStepReconcilerAction[*beatcrd.Filebeat, *rbacv1.RoleBinding]
	isOpenshift bool
}

func newRoleBindingReconciler(client client.Client, recorder record.EventRecorder, isOpenshift bool) (multiPhaseStepReconcilerAction multiphase.MultiPhaseStepReconcilerAction[*beatcrd.Filebeat, *rbacv1.RoleBinding]) {
	return &roleBindingReconciler{
		MultiPhaseStepReconcilerAction: multiphase.NewMultiPhaseStepReconcilerAction[*beatcrd.Filebeat, *rbacv1.RoleBinding](
			client,
			RoleBindingPhase,
...
func (r *roleBindingReconciler) Read(ctx context.Context, o *beatcrd.Filebeat, data map[string]any, logger *logrus.Entry) (read multiphase.MultiPhaseRead[*rbacv1.RoleBinding], res reconcile.Result, err error) {
