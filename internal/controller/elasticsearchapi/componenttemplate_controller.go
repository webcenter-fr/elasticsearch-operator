...
type ComponentTemplateReconciler struct {
	...
	remote.RemoteReconciler[*elasticsearchapicrd.ComponentTemplate, *eshandlerpatch.ComponentTemplate, eshandler.ElasticsearchHandler]
...
func NewComponentTemplateReconciler(client client.Client, logger *logrus.Entry, recorder record.EventRecorder) controller.Controller {
	return &ComponentTemplateReconciler{
		...
		RemoteReconciler: remote.NewRemoteReconciler[*elasticsearchapicrd.ComponentTemplate, *eshandlerpatch.ComponentTemplate, eshandler.ElasticsearchHandler](
			client,
