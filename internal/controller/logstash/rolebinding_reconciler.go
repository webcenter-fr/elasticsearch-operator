...
func (r *roleBindingReconciler) Apply(ctx context.Context, o *logstashcrd.Logstash, data map[string]any, objects []*rbacv1.RoleBinding, logger *logrus.Entry) (res reconcile.Result, err error) {
