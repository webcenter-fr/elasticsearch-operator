...
func (t *ElasticsearchapiControllerTestSuite) SetupSuite() {
	...
	userReconciler.(*UserReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.User, *olivere.XPackSecurityPutUserRequest](
		userReconciler.(*UserReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.User, *olivere.XPackSecurityPutUserRequest], res reconcile.Result, err error) {
	...
	licenseReconciler.(*LicenseReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.License, *olivere.XPackInfoLicense](
		licenseReconciler.(*LicenseReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.License, *olivere.XPackInfoLicense], res reconcile.Result, err error) {
	...
	roleReconciler.(*RoleReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.Role, *eshandler.XPackSecurityRole](
		roleReconciler.(*RoleReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.Role, *eshandler.XPackSecurityRole], res reconcile.Result, err error) {
	...
	roleMappingReconciler.(*RoleMappingReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.RoleMapping, *olivere.XPackSecurityRoleMapping](
		roleMappingReconciler.(*RoleMappingReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.RoleMapping, *olivere.XPackSecurityRoleMapping], res reconcile.Result, err error) {
	...
	ilmReconciler.(*IndexLifecyclePolicyReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.IndexLifecyclePolicy, *olivere.XPackIlmGetLifecycleResponse](
		ilmReconciler.(*IndexLifecyclePolicyReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.IndexLifecyclePolicy, *olivere.XPackIlmGetLifecycleResponse], res reconcile.Result, err error) {
	...
	slmReconciler.(*SnapshotLifecyclePolicyReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.SnapshotLifecyclePolicy, *eshandler.SnapshotLifecyclePolicySpec](
		slmReconciler.(*SnapshotLifecyclePolicyReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.SnapshotLifecyclePolicy, *eshandler.SnapshotLifecyclePolicySpec], res reconcile.Result, err error) {
	...
	snapshotRepositoryReconciler.(*SnapshotRepositoryReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.SnapshotRepository, *olivere.SnapshotRepositoryMetaData](
		snapshotRepositoryReconciler.(*SnapshotRepositoryReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.SnapshotRepository, *olivere.SnapshotRepositoryMetaData], res reconcile.Result, err error) {
	...
	componentTemplateReconciler.(*ComponentTemplateReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.ComponentTemplate, *olivere.IndicesGetComponentTemplate](
		componentTemplateReconciler.(*ComponentTemplateReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.ComponentTemplate, *olivere.IndicesGetComponentTemplate], res reconcile.Result, err error) {
	...
	indexTemplateReconciler.(*IndexTemplateReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.IndexTemplate, *olivere.IndicesGetIndexTemplate](
		indexTemplateReconciler.(*IndexTemplateReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.IndexTemplate, *olivere.IndicesGetIndexTemplate], res reconcile.Result, err error) {
	...
	watchReconciler.(*WatchReconciler).reconcilerAction = mock.NewMockRemoteReconcilerAction[*elasticsearchapicrd.Watch, *olivere.XPackWatch](
		watchReconciler.(*WatchReconciler).reconcilerAction,
		func(ctx context.Context, req reconcile.Request, o object.RemoteObject) (handler controller.RemoteExternalReconciler[*elasticsearchapicrd.Watch, *olivere.XPackWatch], res reconcile.Result, err error) {
