...
type indexLifecyclePolicyValidator struct {
	logger *logrus.Entry
...
func (r *indexLifecyclePolicyValidator) validateResourceUnicity(obj *IndexLifecyclePolicy) *field.Error {
	...
	listObjects := &IndexLifecyclePolicyList{}
...
func (r *indexLifecyclePolicyValidator) validateExplicitPolicyOrRawPolicy(obj *IndexLifecyclePolicy) *field.Error {
	if obj.IsRawPolicy() {
		if obj.Spec.Policy != nil {
			return field.Forbidden(field.NewPath("spec").Child("rawPolicy"), "When you set field 'spec.rawPolicy', you can't set field 'spec.policy'")
		}
	} else {
		if obj.Spec.Policy == nil {
			return field.Required(field.NewPath("spec"), "You need to provide 'spec.rawPolicy' or 'spec.policy'")
		}
	}
